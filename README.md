...
<div style="display: flex; justify-content: center; align-items: center; gap: 15px; flex-wrap: wrap; margin-bottom: 20px; padding: 0 10px;">
...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; width: 100%; max-width: 800px;">
  <div style="flex: 1; min-width: 300px; max-width: 400px;">
    <img alt="GitHub Stats" src="https://github-readme-stats.vercel.app/api?username=Manvanth-Gowda-M&show_icons=true&theme=radical&count_private=true&include_all_commits=true&hide_title=false" style="width: 100%; height: auto;" />
  </div>
  <div style="flex: 1; min-width: 300px; max-width: 400px;">
    <img alt="Top Languages" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Manvanth-Gowda-M&layout=compact&theme=radical&count_private=true&hide_title=false" style="width: 100%; height: auto;" />
  </div>
</div>

<!-- GitHub Streak -->
<div style="width: 100%; max-width: 500px;">
  <img alt="GitHub Streak" src="https://github-readme-streak-stats.herokuapp.com/?user=Manvanth-Gowda-M&theme=radical&border=58A6FF&background=0d1117&ring=58A6FF&fire=58A6FF&currStreakLabel=58A6FF" style="width: 100%; height: auto;" />
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; padding: 0 15px; max-width: 800px; margin: 0 auto;">

<!-- Email -->
<div>
  <a href="mailto:appumanu3214@gmail.com" style="display: inline-block; padding: 15px 25px; background: linear-gradient(45deg, #EA4335, #FBBC04); color: white; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(234, 67, 53, 0.4);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(234, 67, 53, 0.6)'; this.style.background='linear-gradient(45deg, #FBBC04, #34A853)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(234, 67, 53, 0.4)'; this.style.background='linear-gradient(45deg, #EA4335, #FBBC04)';">
...
<!-- LinkedIn -->
<div>
  <a href="https://www.linkedin.com/in/manvanth-gowda-m-50288039b" style="display: inline-block; padding: 15px 25px; background: linear-gradient(45deg, #0077B5, #00A0DC); color: white; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0, 119, 181, 0.4);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(0, 119, 181, 0.6)'; this.style.background='linear-gradient(45deg, #00A0DC, #0077B5)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0, 119, 181, 0.4)'; this.style.background='linear-gradient(45deg, #0077B5, #00A0DC)';">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 10px; vertical-align: middle;">
...
<!-- Instagram -->
<div>
  <a href="https://www.instagram.com/appu_kannadigaa" style="display: inline-block; padding: 15px 25px; background: linear-gradient(45deg, #E4405F, #C13584, #833AB4); color: white; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(228, 64, 95, 0.4);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(228, 64, 95, 0.6)'; this.style.background='linear-gradient(45deg, #C13584, #833AB4, #FD1D1D)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(228, 64, 95, 0.4)'; this.style.background='linear-gradient(45deg, #E4405F, #C13584, #833AB4)';">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 10px; vertical-align: middle;">
...
<!-- Portfolio -->
<div>
  <a href="https://manvanth.vercel.app/" style="display: inline-block; padding: 15px 25px; background: linear-gradient(45deg, #6A5ACD, #7B68EE); color: white; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(106, 90, 205, 0.4);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(106, 90, 205, 0.6)'; this.style.background='linear-gradient(45deg, #7B68EE, #6A5ACD)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(106, 90, 205, 0.4)'; this.style.background='linear-gradient(45deg, #6A5ACD, #7B68EE)';">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 10px; vertical-align: middle;">
...
<a href="https://www.linkedin.com/in/manvanth-gowda-m-50288039b" style="display: inline-block; padding: 15px 30px; background: linear-gradient(45deg, #0077B5, #00A0DC); color: white; text-decoration: none; border-radius: 25px; font-weight: bold; font-size: 16px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0, 119, 181, 0.4);" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(0, 119, 181, 0.6)'; this.style.background='linear-gradient(45deg, #00A0DC, #0077B5)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0, 119, 181, 0.4)'; this.style.background='linear-gradient(45deg, #0077B5, #00A0DC)';">
