...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="65%" valign="top">
      <!-- SYSTEM LOG: BIO -->
      <table width="100%" bgcolor="#000000" style="border: 8px solid #FF5F1F; box-shadow: 15px 15px 0px #FF5F1F;">
        <tr>
          <td style="padding: 20px;">
            <h1 style="color: #FF5F1F; font-family: 'Arial Black', sans-serif; margin: 0; font-size: 32px; border-bottom: 4px solid #FF5F1F; padding-bottom: 10px;">CORE_IDENTITY.INF</h1>
            <p align="left" style="color: #FFFFFF; font-family: 'Courier New', monospace; font-size: 16px; line-height: 1.6; margin-top: 20px;">
              > <b>SUBJECT:</b> MANVANTH GOWDA M<br/>
              > <b>STATUS:</b> FULL-STACK ARCHITECT // AI ENGINEER<br/>
              > <b>LOCATION:</b> BENGALURU, IN<br/>
              > <b>DIRECTIVE:</b> EXTRACTING VALUE FROM CHAOS.<br/>
              > <span style="background: #FF5F1F; color: #000; padding: 2px 5px;">MISSION_READY: TRUE</span>
            </p>
          </td>
        </tr>
      </table>
    ...
    <td width="35%" valign="top" style="padding-left: 20px;">
      <!-- SYSTEM UPTIME -->
      <table width="100%" bgcolor="#FF5F1F" style="border: 8px solid #000000; box-shadow: 15px 15px 0px #000000;">
        <tr>
          <td style="padding: 20px;">
            <h3 style="color: #000; font-family: 'Arial Black', sans-serif; margin: 0;">UPTIME</h3>
            <p style="color: #000; font-family: 'Arial Black', sans-serif; font-size: 28px; margin: 0;">100%</p>
            <p style="color: #000; font-family: 'Courier New', monospace; font-size: 12px; margin: 0;">SINCE_BOOT: 2002</p>
          </td>
        </tr>
      </table>
    </td>
...
<div style="border: 10px solid #000000; background-color: #FF5F1F; padding: 25px;">
  ...
  <br/>
  <div align="center">
    <p style="color: #000; font-family: 'Courier New', monospace; font-weight: bold; margin: 0;">
      [!] CONNECTION_TERMINATED // SESSION_SAVED // REPOSITORY_SYNC_SUCCESS
    </p>
  </div>
</div>
